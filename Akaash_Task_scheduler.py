...
def sort_tasks():
    tasks = list_tasks()
    tasks = [(task.get_children()[0].get_object().content, task.get_children()[1].get_object().content, task.get_children()[2].get_object().content) for task in tasks]
